...
//get a namespace
var ns = namespace("window.jermaine.whatever");

//usual usage
var ns = namespace("window.jermaine.whatever", function (ns) {
    //add something to the namespace

    ns.whatever = {};
}

//using local namespace variables
var ns = namespace("window.jermaine.whatever",
{ anotherns: "window.jermaine.anotherns",
  ns2: "window.jermaine.ns2"
},
function(ns) {
  this.anotherns.whatever;
  this.ns2.thing;
}
...
describe("namespace utility", function () {
    ...
    it("should make the aliases accessible in the namespace function", function () {
        var ns1 = namespace("aliases.testOne");
        var ns2 = namespace("aliases.testTwo", function (exports) {
            exports.Thing = function () {};
        });

        var ns3 = namespace("aliases.testThree",
                            { ns1: "aliases.testOne",
                              ns2: "aliases.testTwo" },
                            function (ns) {
